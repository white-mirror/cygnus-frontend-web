...
export const PanelFooter: FC<PanelFooterProps> = ({
  ...
  const buttonClasses = cn(
    "flex h-16 w-16 items-center justify-center rounded-full text-[var(--text-primary)] transition-transform duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[rgb(var(--confirm-accent))] focus-visible:ring-offset-2 focus-visible:ring-offset-[var(--surface)] transform-gpu will-change-transform",
    isDisabled
      ? "bg-[rgba(148,163,184,0.45)] text-[var(--text-primary)]/70 pointer-events-none"
